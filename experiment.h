...
void common_part(int mode);

void myfunc_add(const uint64_t* operand1, const uint64_t* operand2, int coeff_count, int coeff_modulus_size, int ope1_size, int ope2_size, const seal::Modulus* modulus , uint64_t* result);
